...
FN_TOTAL=$(echo $FN_ACSMHK + $FN_CBI + $FN_CGST + $FN_DSCCC + $FN_FLWC + $FN_FVC + $FN_HKBC + $FN_JNG + $FN_WWBS + $FN_YFCX | bc)
...
CHNG_CNT_TOTAL=$(echo $CHNG_CNT_ACSMHK + $CHNG_CNT_CBI + $CHNG_CNT_CGST + $CHNG_CNT_DSCCC + $CHNG_CNT_FLWC + $CHNG_CNT_FVC + $CHNG_CNT_HKBC + $CHNG_CNT_JNG + $CHNG_CNT_WWBS + $CHNG_CNT_YFCX | bc)
