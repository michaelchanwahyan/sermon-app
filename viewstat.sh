...
FN_HKBC=$(   ls -1 ./data/HKBC/*.txt    | wc -l)
...
echo GFC     \| $(printf "%.1f" $((10**4 * FN_GFC     / FN_TOTAL))e-2)% \($FN_GFC     / $FN_TOTAL\) \| $(printf "%.1f" $((10**4 * CHNG_CNT_GFC     / CHNG_CNT_TOTAL))e-2)% \($CHNG_CNT_GFC     / $CHNG_CNT_TOTAL\)
