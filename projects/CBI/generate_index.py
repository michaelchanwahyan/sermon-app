...
import os
_ = os.system("rm -f cbi.videos")
_ = os.system("wget -O cbi.videos https://www.youtube.com/@CBI_HK/videos")
_ = os.system("rm -f cbi.streams")
_ = os.system("wget -O cbi.streams https://www.youtube.com/@CBI_HK/streams")
_ = os.system("cat cbi.videos cbi.streams > videos")
_ = os.system("rm -f cbi.*")
...
ls > ~/SOURCE/sermon-app/projects/CBI/exlist.txt

vim ~/SOURCE/sermon-app/projects/CBI/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('Chinese Bible International completed list contains %d' % len(_list))
...
ls -logtD '%b %d  %Y' *.mp3 > ~/SOURCE/sermon-app/projects/CBI/lslogt.txt
'''
