...
_ = os.system("wget https://www.youtube.com/@CBIsupport/videos")
...
vim ~/SOURCE/sermon-app/projects/CBI/lslogt.txt # remove the trailing '.mp3' on each row'''
