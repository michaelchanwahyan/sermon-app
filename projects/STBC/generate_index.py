...
cd ~/TPPHC/SERMON/STBC/

ls > ~/SOURCE/sermon-app/projects/STBC/exlist.txt

vim ~/SOURCE/sermon-app/projects/STBC/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('Shatin Baptist Church completed list contains %d' % len(_list))
...
ls -logtD '%b %d  %Y' *.mp3 | awk '{print substr($0,index($0,$4))}' > ~/SOURCE/sermon-app/projects/STBC/lslogt.txt
'''
