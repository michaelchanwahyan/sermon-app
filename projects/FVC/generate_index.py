...
_ = os.system("wget https://www.youtube.com/@fairviewchurch/videos")
'''
...
vim ~/SOURCE/sermon-app/projects/FVC/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('Fairview Church completed list contains %d' % len(_list))
'''
...
'''
cd ~/TPPHC/SERMON/FVC/
ls *.mp3 > ~/SOURCE/sermon-app/projects/FVC/ls.txt
'''
