...
_ = os.system("wget -O videos https://www.youtube.com/@yauoischool/streams")
...
ls *.mp3 > ~/SOURCE/sermon-app/projects/YOS/exlist.txt

#vim ~/SOURCE/sermon-app/projects/YOS/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('Yau Oi School completed list contains %d' % len(_list))
...
ls -logtD '%b %d  %Y' *.mp3 | awk '{print substr($0,index($0,$4))}' > ~/SOURCE/sermon-app/projects/YOS/lslogt.txt
'''
