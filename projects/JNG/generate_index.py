...
ls *.mp3 > ~/SOURCE/sermon-app/projects/JNG/exlist.txt
...
preacherTitle_list = ['博士','牧師','傳道','老師','先生','教授','弟兄','社長','醫生']
...
ls -logtD '%b %d  %Y' *.mp3 | awk '{print substr($0,index($0,$4))}' > ~/SOURCE/sermon-app/projects/JNG/lslogt.txt
'''
