...
_ = os.system("wget -O videos https://www.youtube.com/@flowchurchhk/streams")
...
ls > ~/SOURCE/sermon-app/projects/FLWC/exlist.txt

vim ~/SOURCE/sermon-app/projects/FLWC/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('FlowChurch completed list contains %d' % len(_list))
