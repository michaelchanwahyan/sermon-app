...
'''
# obtain the whole webpage of the sermon videos uploaded by Urban Voice Community Church

# note: streams contains live streams during covid pandemic
import os
_ = os.system("rm -f videos")
_ = os.system("wget https://www.youtube.com/@UrbanVoice/videos")
'''
...
ls *.mp3 > ~/SOURCE/sermon-app/projects/UVC/exlist.txt

vim ~/SOURCE/sermon-app/projects/UVC/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('ACSMHK completed list contains %d' % len(_list))
'''
...
'''
cd ~/TPPHC/SERMON/UVC/
ls *.mp3 > ~/SOURCE/sermon-app/projects/UVC/ls.txt
'''
