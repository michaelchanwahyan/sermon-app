...
_ = os.system("wget -O videos https://www.youtube.com/@MKBC/streams")
'''
...
ls > ~/SOURCE/sermon-app/projects/MKBC/exlist.txt

vim ~/SOURCE/sermon-app/projects/MKBC/exlist.txt # edit to only preserve the 11-character hash code'''
...
print('Mongkok Baptist Church completed list contains %d' % len(_list))
'''
