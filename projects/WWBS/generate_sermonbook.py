...
def print_prefix(sermon_tex_filepath, progressStepCnt):
    ...
    _ = os.system(f"cat ../prefix.tex | sed 's/粵語講道逐字稿/環球聖經公會 粵語講道逐字稿/' | sed 's/Youtube Channel:/Youtube Channel: Worldwide Bible Society/' > " + sermon_tex_filepath)
...
def generate_toc(sermon_tex_filepath, index_file, toc_type, progressStepCnt):
    ...
    with open(sermon_tex_filepath, "a") as fp:
        ...
        for lineId, line in enumerate(lines):
            ...
            # --------------------------------------
            if os.path.isfile(f'../../data/WWBS/{cc}.txt'):
...
def write_sermon_text(fp, cc):
    with open("../../data/WWBS/"+cc+".txt", "r") as fp_:
...
def sermon_tex():
    progressStepCnt = 0
    sermon_tex_filepath = f"../../build/WWBS/sermon_WWBS.tex"
    # --------------------------------------
    ...
    # --------------------------------------
    # --------------------------------------
    progressStepCnt = generate_toc(sermon_tex_filepath, './index_byn.csv', 'title', progressStepCnt)
