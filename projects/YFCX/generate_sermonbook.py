...
def text_transform_cantonStyle2normalStyle(cantonText):
    ...
    cantonText = re.sub(r'卫', '衛', cantonText)
    ...
    cantonText = re.sub(r'噜', '嚕', cantonText)
    ...
    cantonText = re.sub(r'够', '夠', cantonText)
    ...
    cantonText = re.sub(r'归', '歸', cantonText)
    ...
    cantonText = re.sub(r'恋', '戀', cantonText)
    ...
    cantonText = re.sub(r'扫', '掃', cantonText)
    cantonText = re.sub(r'抛', '拋', cantonText)
    cantonText = re.sub(r'护', '護', cantonText)
    ...
    cantonText = re.sub(r'撵', '攆', cantonText)
    ...
    cantonText = re.sub(r'无', '無', cantonText)
    cantonText = re.sub(r'昼', '晝', cantonText)
    cantonText = re.sub(r'晓', '曉', cantonText)
    cantonText = re.sub(r'晗', '含', cantonText)
    ...
    cantonText = re.sub(r'滞', '淨', cantonText)
    ...
    cantonText = re.sub(r'犹', '猶', cantonText)
    cantonText = re.sub(r'猪', '豬', cantonText)
    cantonText = re.sub(r'猬', '蝟', cantonText)
    cantonText = re.sub(r'献', '獻', cantonText)
    ...
    cantonText = re.sub(r'祸', '禍', cantonText)
    ...
    cantonText = re.sub(r'耻', '恥', cantonText)
    cantonText = re.sub(r'肠', '腸', cantonText)
    cantonText = re.sub(r'肤', '膚', cantonText)
    cantonText = re.sub(r'肶', '脾', cantonText)
    cantonText = re.sub(r'胧', '朧', cantonText)
    ...
    cantonText = re.sub(r'苏', '蘇', cantonText)
    ...
    cantonText = re.sub(r'订', '訂', cantonText)
    ...
    cantonText = re.sub(r'败', '敗', cantonText)
    cantonText = re.sub(r'赋', '賦', cantonText)
    cantonText = re.sub(r'赐', '賜', cantonText)
    ...
    cantonText = re.sub(r'辅', '輔', cantonText)
    cantonText = re.sub(r'辈', '輩', cantonText)
    ...
    cantonText = re.sub(r'邮', '郵', cantonText)
    ...
    cantonText = re.sub(r'饿', '餓', cantonText)
