...
_ = os.system("wget https://www.youtube.com/@acsmhk/videos")
'''
...
vim ~/SOURCE/sermon-app/projects/ACSMHK/exlist.txt # edit to only preserve the 11-character hash code'''
...
df.chapter = pd.to_numeric(df.chapter, errors='coerce')
df = df.sort_values(['preacher', 'bkno', 'chapter', 'title'])
