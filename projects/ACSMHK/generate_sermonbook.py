...
sermon_tex_filepath = f"../../build/ACSMHK/sermon_ACSMHK.tex"
# --------------------------------------
# print the latex document : prefix
# --------------------------------------
progressStepCnt += 1
print(f"Step {progressStepCnt}: printing out prefixing")
_ = os.system(f"cat ../prefix.tex | sed 's/粵語講道逐字稿/宣道傳意及出版事工 粵語講道逐字稿/' | sed 's/Youtube Channel:/Youtube Channel: Alliance Communications Ministry/' > " + sermon_tex_filepath)
